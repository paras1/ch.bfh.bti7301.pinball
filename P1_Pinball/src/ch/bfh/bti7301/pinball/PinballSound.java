...
public class PinballSound {
    ...
    private void loadSounds()
    {
		...
		mSoundPoolMap.put(ID_START, Gdx.audio.newSound(Gdx.files.internal("data/audio/startup1.ogg")));
		mSoundPoolMap.put(ID_LAUNCH, Gdx.audio.newSound(Gdx.files.internal("data/audio/mario_jump.ogg")));
		mSoundPoolMap.put(ID_FLIPPER, Gdx.audio.newSound(Gdx.files.internal("data/audio/FlipperUp.ogg")));
		mSoundPoolMap.put(ID_BUMPERS, Gdx.audio.newSound(Gdx.files.internal("data/audio/Bumper.ogg")));
		mSoundPoolMap.put(ID_SLINGSHOT, Gdx.audio.newSound(Gdx.files.internal("data/audio/Sling.ogg")));
		mSoundPoolMap.put(ID_GAMEOVER, Gdx.audio.newSound(Gdx.files.internal("data/audio/GameOver.ogg")));
    }
