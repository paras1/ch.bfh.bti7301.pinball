...
public abstract class FieldElement {
	...
	/**
	 * Extracts common values from the definition parameter map, and calls
	 * finishCreate to allow subclasses to further initialize themselves.
	 * Subclasses should override finishCreate, and should not override this
	 * method.
	 */
	...
	/**
	 * Must be overridden by subclasses to return a collection of all Box2D
	 * bodies which make up this element.
	 */
	public abstract List<Body> getBodies();

	/**
	 * Must be overridden by subclasses, which should perform any setup required
	 * after creation.
	 */
	public abstract void finishCreate(Map params, World world);

	/**
	 * Returns this element's ID as specified in the JSON definition, or null if
	...
	/**
	 * Returns the "score" value for this element. The score is automatically
	 * added when the element is hit by a ball, and elements may apply scores
	 * under other conditions, e.g. RolloverGroupElement adds the score when a
	 * ball comes within range of a rollover.
	 */
