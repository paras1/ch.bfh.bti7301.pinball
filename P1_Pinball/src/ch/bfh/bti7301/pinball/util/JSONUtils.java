...
/**
 * JSONUtils, this class is a utils class for reading an creating JSON files
 * 
...
public class JSONUtils {
	...
	/**
	 * If argument is a JSONArray or JSONObject, returns the equivalent List or
	 * Map. If argument is JSONObject.NULL, returns null. Otherwise, returns the
	 * argument unchanged.
	 */
	...
	/**
	 * Returns a List with the same objects in the same order as jsonArray.
	 * Recursively converts nested JSONArray and JSONObject values to List and
	 * Map objects.
	 */
	...
	/**
	 * Returns a List with the same keys and values as jsonObject. Recursively
	 * converts nested JSONArray and JSONObject values to List and Map objects.
	 */
	...
	/**
	 * Returns a List created by parsing the string argument as a JSON array and
	 * calling listFromJSONArray.
	 */
	...
	/**
	 * Returns a Map created by parsing the string argument as a JSON object and
	 * calling mapFromJSONObject.
	 */
