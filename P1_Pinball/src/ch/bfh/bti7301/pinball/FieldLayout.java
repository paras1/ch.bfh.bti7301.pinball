...
/**
 * The FieldLayout class get the saved GameAreas(json file) and provide getters
 * and setters for the elements and their parameters like bumper size
 * 
 * 
...
public class FieldLayout {
	...
	public List addFieldElements(Map layoutMap, String key, Class defaultClass,
		...
		for (Object obj : listForKey(layoutMap, key)) {
			...
			if (!(obj instanceof Map))
				continue;
			Map params = (Map) obj;
			elements.add(FieldElement.createFromParameters(params, world,
					defaultClass));
		}
	...
	public int getNumberOfBalls() {
		return (allParameters.containsKey("numballs")) ? ((Number) allParameters
